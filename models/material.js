...
const storageSchema = new mongoose.Schema({
    ...
    storageUnit: {
        ...
        trim: true,
        default: 'box',
        enum: ['box', 'piece', 'unit', 'case', 'bag', 'bale', 'roll', 'tote'],
    },
    casePack: { type: Number, default: 0, min: 0 }, // legacy; prefer unitsPerBox
    piecesPerUnit: { type: Number, default: 1, min: 0 },
    ...
    defaultPickLevel: {
        ...
        trim: true,
        default: 'box',
        enum: ['unit', 'box', 'pallet', 'bale', 'bag', 'roll', 'tote', 'piece', 'case'],
    },
